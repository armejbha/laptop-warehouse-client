        ...
        <div className='bg-cyan-700 h-screen pt-48 '>
            <div className='w-4/12 bg-white mx-auto rounded-lg py-16'>
                ...
                <form className='w-8/12 mx-auto'>
                    <input className='block w-full outline-0 bg-sky-100 text-bold py-1 px-4 rounded-full' type="text" name="name" id="" placeholder='Your Name' />
                    <input className='block w-full outline-0 bg-sky-100 text-bold py-1 px-4 rounded-full mt-2' type="email" name="email" id="" placeholder='Enter Email' />
                ...
                <p className='text-center mt-4'>Already have an Account?<Link className='text-sky-500' to='/login'>Login</Link></p>
            </div>
        </div>
    );
};
