        ...
        <div className='bg-gradient-to-r from-cyan-900 to-cyan-600 h-screen'>
            <div div className='grid md:grid-cols-2 items-center gap-8 md:gap-4 mx-4 md:mx-12 py-16 md:py-24' >
                <div className='order-2 md:order-1'>
                    ...
                    <p className='py-4 text-gray-900'>Laptop warehouse is one the best laptop stock house in the world.Here every company laptop have store And a lot supplier laptop supply from this warehouse.</p>
