...
const Contact = () => {
    return (
        <div className='md:w-1/2 mx-auto text-center py-16'>
            ...
            <p className='text-lg font-light mt-2 text-gray-600'>Interested in speaking with one of our developer or to our communications team?We would love to hear from you!</p>
